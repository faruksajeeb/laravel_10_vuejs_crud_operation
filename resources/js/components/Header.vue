    ...
    <div class="px-3 py-2 bg-dark text-white">
      <div class="container">
        ...
        >
          <router-link
            to="/"
            class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-danger text-decoration-none fw-bold h1"
          > LaravelVue
          </router-link>
          <ul
          ...
          >
            ...
            <li>
              <router-link to="/products/create" class="btn btn-outline-primary btn-sm float-end"
